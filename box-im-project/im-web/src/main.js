...
// 注册 Element UI 并绑定全局消息与弹窗
Vue.use(ElementUI);
Vue.prototype.$message = Message; // 全局消息
Vue.prototype.$confirm = MessageBox.confirm; // 全局确认弹窗
Vue.prototype.$prompt = MessageBox.prompt; // 全局输入弹窗
if (typeof window !== 'undefined') { window.__message = Message; }
